...
class Ui_PlagiarismWindow(object):
    def setupUi(self, PlagiarismWindow):
        ...
        self.startBtn.setGeometry(QtCore.QRect(280, 479, 240, 60))
        font = QtGui.QFont()
        ...
        self.authorComboBox.setStyleSheet("border-width: 3px;\n"
                                          "border-radius: 5px;\n"
                                          "border-color: rgb(0, 0, 0);\n"
                                          "border-style: solid;")
        ...
        self.path.setStyleSheet("border-width: 3px;\n"
                                "border-radius: 5px;\n"
                                "border-color: rgb(0, 0, 0);\n"
                                "border-style: solid;")
    ...
    def retranslateUi(self, PlagiarismWindow):
        ...
        self.trainBtn.setText(_translate("PlagiarismWindow", "Train"))
