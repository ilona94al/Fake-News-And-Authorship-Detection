...
class ChooseTrainWinController(QMainWindow):
    def __init__(self, parent=None):
        ...
        from gui.choose_train_window import Ui_ChooseTrainWindow
    ...
    def next_pressed(self):
        ...
        if model_type == combo_box_options['option1']:
            from gui.trainPlagModelWinController import TrainPlagModelWinController
            self.window = TrainPlagModelWinController()
        if model_type == combo_box_options['option2']:
            from gui.trainNewsModelWinController import TrainNewsModelWinController
